...
public class MyMainApp {
    ...
    private static void addNewBook() {
        ...
        bookQuantityService.addBook(book.getId(), quantity);
    ...
    private static void deleteBook() {
        try {
            ...
            for (Book book : allBooks) {
                int quantity = bookQuantityService.getQuantity(book);
                System.out.printf("Book ID: %d, Title: %s, Author: %s, Available: %d%n",
                        book.getId(), book.getTitle(), book.getAuthor(), quantity);
            }
            ...
            System.out.println("\nBook to be deleted:");
            System.out.printf("Book ID: %d, Title: %s, Author: %s%n",
                    bookToDelete.getId(), bookToDelete.getTitle(), bookToDelete.getAuthor());
            ...
            System.out.println("Error during book deletion: " + e.getMessage());
            logger.logBookOperation("DELETE_BOOK",
